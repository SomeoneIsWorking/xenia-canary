...
bool Win32WindowedAppContext::Initialize() {
  ...
  if (shcore_module_) {
    ...
    per_monitor_dpi_v1_api_available_ &=
        (per_monitor_dpi_v1_api_.get_dpi_for_monitor = reinterpret_cast<
             decltype(per_monitor_dpi_v1_api_.get_dpi_for_monitor)>(
  ...
  if (user32_module_) {
    ...
    per_monitor_dpi_v2_api_available_ &=
        (per_monitor_dpi_v2_api_.adjust_window_rect_ex_for_dpi =
             reinterpret_cast<decltype(per_monitor_dpi_v2_api_
    ...
    per_monitor_dpi_v2_api_available_ &=
        (per_monitor_dpi_v2_api_.enable_non_client_dpi_scaling =
             reinterpret_cast<decltype(per_monitor_dpi_v2_api_
                 ...
                 GetProcAddress(user32_module_,
                                "EnableNonClientDpiScaling"))) != nullptr;
    per_monitor_dpi_v2_api_available_ &=
        (per_monitor_dpi_v2_api_.get_dpi_for_system = reinterpret_cast<
             decltype(per_monitor_dpi_v2_api_.get_dpi_for_system)>(
             GetProcAddress(user32_module_, "GetDpiForSystem"))) != nullptr;
    per_monitor_dpi_v2_api_available_ &=
        (per_monitor_dpi_v2_api_.get_dpi_for_window = reinterpret_cast<
             decltype(per_monitor_dpi_v2_api_.get_dpi_for_window)>(
